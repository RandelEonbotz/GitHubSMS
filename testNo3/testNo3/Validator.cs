...
namespace testNo3
{
    public static class Validator
    {
        ...
        public static bool AddConfirmation()
        {
            ...
            //if (MessageBox.Show("Do you want to Add ?", "Add Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            //{


            //    //DialogResult dr = MessageBox.Show("Do you want to Add ?", "Add Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question);   // =======================  bugs in some file on SMS
