...
namespace testNo3
{
    class Connection
    {
        ...
        {
            conn = new MySqlConnection(holder.connectionstring);
            ...
            //conn = new MySqlConnection("server=192.168.1.2;user id=Randel; password=RandelEonbotz2021;database=amsaismsdbv1;port=3306;SSL Mode=None");
